...
import { useData, User, VitalsState } from "@/contexts/data-provider";
import { Avatar, AvatarFallback, AvatarImage } from "./ui/avatar";
import { Button } from "./ui/button";
import { Card, CardContent, CardDescription, CardHeader, CardTitle } from "./ui/card";
import { Switch } from "./ui/switch";
import { Droplets, Heart, HeartPulse, Monitor, Thermometer, Waves } from "lucide-react";
...
export function TeleIcuDashboard() {
    const { allUsers, toggleMonitoring } = useData();
        ...
        <div className="p-4 sm:p-6 md:p-8">
            <header className="flex items-center justify-between pb-4 border-b">
                ...
                <div className="flex items-center gap-2">
                    ...
                    <h1 className="text-2xl font-bold">Tele-ICU Portal</h1>
                </div>
            </header>
